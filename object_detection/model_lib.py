  ...
  for index, (eval_spec_name, eval_input_fn) in enumerate(
    ...
    eval_specs.append(
        tf.estimator.EvalSpec(
            ...
            steps=None,
            exporters=exporter, throttle_secs=0, start_delay_secs=10))

  if eval_on_train_data:
    eval_specs.append(
        tf.estimator.EvalSpec(
            name='eval_on_train', input_fn=eval_on_train_input_fn, steps=None, throttle_secs=5, start_delay_secs=0))
